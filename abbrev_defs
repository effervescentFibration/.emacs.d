...
(define-abbrev-table 'sml-prog-proc-comint-mode-abbrev-table '())

(define-abbrev-table 'sml-prog-proc-mode-abbrev-table '())
...
(define-abbrev-table 'urweb-mode-abbrev-table '())
